...
public class UserMainForm extends JFrame implements ActionListener {
    ...
    private final JButton btnViewFacilitySchedule;
    ...
    public UserMainForm() {
        ...
        btnViewFacilitySchedule = new JButton("View Facility Schedule");
        btnViewFacilitySchedule.setBounds(30, 250, 200, 30);
        btnViewFacilitySchedule.addActionListener(this);
        add(btnViewFacilitySchedule);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnSave) {
            ...
            if (e.getSource() == btnViewFacilitySchedule) {
                this.dispose();
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Student count must be a number", null,
            ...
            if (count > facility.getCapacity()) {
                JOptionPane.showMessageDialog(this, "This facility does not support that many students (max "
                        + facility.getCapacity() + ")", null, JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            if (result > 0) {
                JOptionPane.showMessageDialog(this, "Booking added successfully", null,
                        JOptionPane.INFORMATION_MESSAGE);
                loadUserBookings();
            } else if (result == -2) {
                JOptionPane.showMessageDialog(this,
                        "Conflict: either you already have a booking at this time, or the facility is already booked.",
            ...
            if (row == -1) {
                JOptionPane.showMessageDialog(this, "Please select a booking to delete", null,
                        JOptionPane.WARNING_MESSAGE);
                return;
            }

            int bookingId = (int) model.getValueAt(row, 0);
            int confirm = JOptionPane.showConfirmDialog(this, "Delete selected booking?", "Confirm",
